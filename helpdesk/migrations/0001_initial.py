    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Meeting Room', 'Meeting Room'), ('OT', 'OT'), ('VTO', 'VTO'), ('Vacations', 'Vacations'), ('Medical Appointment', 'Medical Appointment'), ('Insurance Appointment', 'Insurance Appointment')], max_length=20)),
                ('is_escalated', models.BooleanField(default=False, help_text='Mark this only if this issue has been previously addressed.', verbose_name='is escalated')),
                ('subject', models.CharField(help_text='Write a title.', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mensajito', models.CharField(default='Vacations! Well deserved', max_length=300)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('content', models.TextField(help_text='Write your message here.', verbose_name='content')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(help_text='Describe the purpose of the image.', max_length=200)),
